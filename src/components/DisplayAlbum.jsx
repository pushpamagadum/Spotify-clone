        ...
        <>
            ...
            <div className='mt-10 flex gap-8 flex-col md:flex-row md:items-end'>
                ...
                <div className='flex flex-col'>
                    ...
                    <p className='mt-1'></p>
                    <b><img className='inline-block w-5' src={assets.spotify_logo} alt="" />
                        {/* <b>Spotify </b>   */}
                        {/* 1,323,154 likes   
                    <b>50 songs,</b>
                    about 2 hr 30 min
                   */}
                        ...
                        <span className='bullet-point'>Spotify 1,323,154 likes</span>
                        <span className='bullet-point'><b>50 songs,</b> about 2 hr 30 min</span>
                    </b>
                </div>
            </div>
